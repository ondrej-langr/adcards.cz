...
import { TwigExpr } from './components/TwigExpr'
...
}> = ({ priceOutlet, imgSrc, titleOutlet, subtitleOutlet }) => <Row className={'mb-6'}>
  ...
  return (
    <Layout baseUrl={baseUrl}>
      ...
      <WhiteSection className='mt-5 px-5 text-[rgba(105,105,105,0.95)]'>
        ...
        <Container className='border-b border-gray-200 border-solid text-lg uppercase text-lg'>
        ...
        <Container className='border-b border-gray-200 border-solid text-lg uppercase text-lg pt-5'>
        ...
        <Container className='border-b border-gray-200 border-solid text-lg uppercase text-lg py-5'>
          <Row>
            <Column>
              {shipping.label}:
            </Column>
