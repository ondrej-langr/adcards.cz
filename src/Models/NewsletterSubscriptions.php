...
#[ORM\Entity, ORM\Table(name: 'newsletter_subscriptions'), PROM\PromModel(ignoreSeeding: true), ORM\HasLifecycleCallbacks]
class NewsletterSubscriptions extends Base\NewsletterSubscriptions
{
}