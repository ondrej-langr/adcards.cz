...
#[ORM\Entity, ORM\Table(name: 'ordered_products'), PROM\PromModel(ignoreSeeding: true), ORM\HasLifecycleCallbacks]
class OrderedProducts extends Base\OrderedProducts
{
}