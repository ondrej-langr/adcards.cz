...
#[ORM\Entity, ORM\Table(name: 'card_backgrounds'), PROM\PromModel(ignoreSeeding: true), ORM\HasLifecycleCallbacks]
class CardBackgrounds extends Base\CardBackgrounds
{
}