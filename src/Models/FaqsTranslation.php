...
#[ORM\Entity, ORM\Table(name: 'faqs_translations'), ORM\UniqueConstraint(name: 'faqs_translations_unique_idx', columns: ['locale', 'object_id']), ORM\HasLifecycleCallbacks]
class FaqsTranslation extends Base\FaqsTranslation
{
}